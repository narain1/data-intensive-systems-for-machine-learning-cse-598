...
test_add_by_const()
print("add by const passed")
test_mul_by_const()
print("mul by const passed")
test_add_two_vars()
print("add two vars passed")
test_mul_two_vars()
print("mul two vars passed")
test_add_mul_mix_1()
print("add mul 1 passed")
test_add_mul_mix_2()
print("add mul 2 passed")
test_add_mul_mix_3()
print("add mul 3 passed")
test_grad_of_grad()
print("grad of grad passed")
